...
public sealed partial class MapPage : Page
{
    ...
    private static string BuildOnlineTileJs()
    {
        ...
        // Overlay JS lives in Core so USGS URL injection cannot break C# raw-string delimiters.
        return LeafletOnlineTileScript.Build(
            lidarOverlayOn: MapLayerPreferences.IsVisible(MapLayerKind.LidarTerrain),
